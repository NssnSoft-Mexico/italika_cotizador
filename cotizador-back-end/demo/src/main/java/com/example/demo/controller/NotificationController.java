...
public class NotificationController {
    ...
    public List<Notifications> getTokenId() {
        return notificationService.obtenerId();
    }

    @DeleteMapping("/deleteTokenId/{id}")
    public ResponseEntity<?> deleteTokenId(@PathVariable Long id) {
        
        notificationService.deleteTokenId(id);
        return ResponseEntity.ok("Token eliminado correctamente.");
    }
}